...
<div id="app">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li><a target="_blank" href="https://github.com/hahadu/php-device">Github page</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <div style="text-align: center; padding: 20px 0;"><img width="150px" src="assets/devices/<?php echo($D['os']['0']) ?>.png" /></div>
                <div style="background-color: #E0E0E0; padding: 5px; border-radius: 3px;">
                    <div class="text-center" style="margin:10px; padding: 10px 0 10px 0; border-radius: 3px;"><div id="pimodel" style="font-size: 90%; font-weight: bolder; text-shadow: 0 1px 0 #fff;"><?php echo($D['cpu']['model_id']); ?></div></div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div id="footer">
                    ...
                    <p class="pull-left" style="font-size: 12px;">Powered by <a target="_blank" href="https://github.com/hahadu"><strong>582167246@qq.com</strong></a> <?php echo($D['version']) ?> all rights reserved.
                    </p>
                </div>
            </div>
        </div>
